...
var ability_catalog: Array[Dictionary] = [
	...
	{"id": "chrono_burst", "label": "+ CHRONO BURST", "method": "upgrade_chrono_burst", "level_property": "chrono_burst_level", "rarity": "Rare", "base_weight": 7.0, "late_level": 15, "late_weight_multiplier": 1.8, "tags": ["crowd-control", "burst"], "synergy_upgrades": ["field_amplifier", "gravity_anchor", "vector_thrusters"], "synergy_abilities": ["gravity_well_level", "freeze_pulse_level"]},
]
