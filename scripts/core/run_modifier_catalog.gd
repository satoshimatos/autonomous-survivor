...
static func get_entries() -> Array[Dictionary]:
	return [
		...
		},
		{
			"id": "solar_furnace",
			"name": "Solar Furnace",
			"summary": "A Solar Bastion reward with scorching tempo, rich boss payouts, scarce supplies, and punishing enemy growth.",
			"spawn_interval_multiplier": 0.64,
			"boss_spawn_interval_multiplier": 0.68,
			"exp_value_multiplier": 1.18,
			"boss_exp_multiplier": 1.6,
			"player_fire_interval_multiplier": 0.88,
			"dynamite_drop_multiplier": 1.45,
			"supply_box_chance_multiplier": 0.52,
			"enemy_speed_growth_multiplier": 1.2,
			"enemy_health_growth_multiplier": 1.28,
			"enemy_damage_growth_multiplier": 1.3,
		},
	]
